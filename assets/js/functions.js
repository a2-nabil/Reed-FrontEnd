(function ($) {
  ...
  ApusThemeCore.prototype = {
    ...
    initSlick: function (element) {
      ...
      element.each(function () {
        var config = {
          ...
          slidesToScroll: 4,
          prevArrow:
            "<button type='button' class='slick-arrow slick-prev'><i class='ti-angle-left' aria-hidden='true'></i></span><span class='textnav'>" +
            superio_ajax.previous +
            "</span></button>",
          nextArrow:
            "<button type='button' class='slick-arrow slick-next'><span class='textnav'>" +
            superio_ajax.next +
            "</span><i class='ti-angle-right' aria-hidden='true'></i></button>",
        };
        ...
        if ($(this).data("slidestoscroll_smallmedium")) {
          var slidestoscroll_smallmedium = $(this).data(
            "slidestoscroll_smallmedium"
          );
        } else {
          var slidestoscroll_smallmedium = smallmedium;
        }
        if ($(this).data("slidestoscroll_extrasmall")) {
          var slidestoscroll_extrasmall = $(this).data(
            "slidestoscroll_extrasmall"
          );
        } else {
    ...
    initMobileMenu: function () {
      ...
      if ($(window).width() < 992) {
        $(
          ".sidebar-wrapper > .sidebar-right, .sidebar-wrapper > .sidebar-left"
        ).perfectScrollbar();
      }
      ...
      $("#apus-header-mobile .top-wrapper-menu .inner-top-menu").on(
        "click",
        function (e) {
          e.stopPropagation();
        }
        ...
        function (e) {
          ...
          if (
            !$this
              ...
              .hasClass("elementor-section-stretched")
          ) {
    ...
    dashboardMenu: function () {
      ...
      if ($(window).width() > 991) {
        if ($("#apus-header").length > 0) {
          ...
          $(".inner-dashboard.container-fluid .sidebar-wrapper .sidebar").css({
            top: header_height,
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_instagram.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    // jobs elements
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_job_board_pro_jobs.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_job_board_pro_jobs_tabs.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_job_board_pro_candidates.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_job_board_pro_employers.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
      }
    );
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/apus_element_job_board_pro_jobs_vertical_carousel.default",
      function ($scope) {
        apusthemecore_init.initSlick($scope.find(".slick-carousel"));
